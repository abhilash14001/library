...
<div id="show"></div>
<?php 	
$fetchbook = $library->selectData($con, "*", "lmsbookloan INNER JOIN lmsbook on lmsbookloan.bookid = lmsbook.bookid INNER JOIN lmsbookcat on lmsbook.bookcategory = lmsbookcat.bookcategory where userid = '$studentid' and loanstatus = 'RESERVED' and bookonloan = 'RESERVED'");
 ?>
