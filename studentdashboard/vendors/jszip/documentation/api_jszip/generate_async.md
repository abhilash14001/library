...
browser, see [JSZip.support]({{site.baseurl}}/documentation/api_jszip/support.php).
...
See also [`decodeFileName` on `JSZip#loadAsync()`]({{site.baseurl}}/documentation/api_jszip/load_async.php#decodefilename-option).
