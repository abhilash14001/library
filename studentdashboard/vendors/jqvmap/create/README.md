...
5. [Booleano](http://code.gustavonarea.net/booleano/index.php) _( Python Package )_
...
You should be able to run [Maptools](http://www.maptools.org/ms4w/index.phtml?page=downloads.php) custom [MS4W installer](http://www.maptools.org/dl/ms4w/ms4w-3.0.6-setup.exe) to get everything you need.
