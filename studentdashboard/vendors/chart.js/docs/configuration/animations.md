...
Another example usage of these callbacks can be found on [Github](https://github.com/chartjs/Chart.js/blob/master/samples/advanced/progress-bar.php): this sample displays a progress bar showing how far along the animation is.
