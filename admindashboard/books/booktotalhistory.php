...
$fetchbook = $library->selectData($con, "DISTINCT booktitle, bookimage, bookdesc, bookauthor, bookedition, ISBN, bookpublisher, bookprice, racknumber, bookcategory", "lmsbook");
...
<?php $q = mysqli_query($con, "select count(bookid) from lmsbook where booktitle = '$title'");
...
<td>
	...
	<a style = "color:red" href = "booktotaldetails.php?bookname=<?php echo $booktitle; ?>"><?php echo $row['booktitle']; ?></a>

	
	</td>
	<td>
<button type ="button" id = "<?php echo $no; ?>" class = "btn btn-primary btn btn-sm imagemodal" data-target="#imagemodall" data-toggle="modal">Click here </button></td>
