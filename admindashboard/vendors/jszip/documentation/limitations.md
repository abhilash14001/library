...
The
[`async` method]({{site.baseurl}}/documentation/api_zipobject/async.php) and the
[`generateAsync` method]({{site.baseurl}}/documentation/api_jszip/generate_async.php)
hold the full result in memory but doesn't freeze the browser. If the result
is too big, and if you can't use the
[`nodeStream` method]({{site.baseurl}}/documentation/api_zipobject/node_stream.php) or the
[`generateNodeStream` method]({{site.baseurl}}/documentation/api_jszip/generate_node_stream.php)
you need to use the underlying
[`StreamHelper`]({{site.baseurl}}/documentation/api_streamhelper.php) to
...
You can use the [encodeFileName]({{site.baseurl}}/documentation/api_jszip/generate.php)
option and the [decodeFileName]({{site.baseurl}}/documentation/api_jszip/load.php)
