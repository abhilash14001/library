...
(see [here for RequireJS](http://requirejs.org/docs/api.php#config-paths)).
...
[its getters]({{site.baseurl}}/documentation/api_zipobject.php) :
...
[this page]({{site.baseurl}}/documentation/howto/write_zip.php) for more
...
[this page]({{site.baseurl}}/documentation/howto/read_zip.php) to see how to
