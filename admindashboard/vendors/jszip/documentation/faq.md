...
[this page]({{site.baseurl}}/documentation/howto/read_zip.php).
...
[this page]({{site.baseurl}}/documentation/limitations.php) for more informations.
...
The method [`file(name, data [,options])`]({{site.baseurl}}/documentation/api_jszip/file_data.php)
