...
archive previously [loaded]({{site.baseurl}}/documentation/api_jszip/load_async.php), the content
...
`options.compression`       | compression | see [file(name, data [,options])]({{site.baseurl}}/documentation/api_jszip/file_data.php)
