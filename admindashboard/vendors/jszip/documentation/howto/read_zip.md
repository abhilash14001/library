...
`FileReader.readAsArrayBuffer(Blob)`, see this [example]({{site.baseurl}}/documentation/examples/read-local-file-api.php).
...
[http](http://nodejs.org/docs/latest/api/http.php) to the
