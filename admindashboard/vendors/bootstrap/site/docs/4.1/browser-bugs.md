...
<table class="bd-browser-bugs table table-bordered table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{% include bugify.php content=bug.upstream_bug %}</td>
      <td>{% include bugify.php content=bug.origin %}</td>
    </tr>
    {% endfor %}
  </tbody>
</table>
...
<table class="bd-browser-bugs table table-bordered table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{% include bugify.php content=feat.upstream_bug %}</td>
      <td>{% include bugify.php content=feat.origin %}</td>
    </tr>
    {% endfor %}
  </tbody>
</table>
