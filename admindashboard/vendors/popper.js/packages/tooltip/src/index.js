...
export default class Tooltip {
   ...
   * @param {Boolean} options.php=false - Insert HTML into the tooltip. If false, the content will inserted with `textContent`.
  ...
  _updateTitleContent(title) {
    ...
    this._clearTitleContent(titleNode, this.options.php, this.reference.getAttribute('title') || this.options.title)
    this._addTitleContent(this.reference, title, this.options.php, titleNode);
    this.options.title = title;
    this.popperInstance.update();
  }
